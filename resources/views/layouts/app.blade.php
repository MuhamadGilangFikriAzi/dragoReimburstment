        ...
        <!-- Navbar -->
                    ...
                    @else
                        ...
                        <div class="user-panel d-flex">
                            <div class="image">
                                ...
                                <img src="{{secure_asset('img/user/'.Auth::user()->foto)}}" class="img-circle elevation-2" alt="User Image">
                                @else
                                <img src="{{secure_asset('img/user/user.png')}}" class="img-circle elevation-2" alt="User Image">
                                @endif
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="#" class="brand-link">
                    <img src="{{secure_asset ('adminlte/dist/img/AdminLTELogo.png')}}" alt="img" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
