                        ...
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    @if ($data->tipe_pengembalian == 'transfer')
                                        <tr>
                                            <td>Bank</td>
                                            <td>: {{$data->user['bank']}}</td>
                                        </tr>
                                        <tr>
                                            <td>No Rekening</td>
                                            <td>: {{$data->user['no_rekening']}}</td>
                                        </tr>
                                    @endif
                                    <tr>
                                        <td>Total</td>
                                    ...
                                    <tr><td><hr></td></tr>
                                    <tr><td colspan="3" align="left">Reimburstment Detail</td></tr>
                                    <tr><td><hr></td></tr>
                            </table>
                            <table>
                                    <tr>
                                    ...
                                    @foreach ($data->detail as $key => $detail)
                                        <tr>
                                            <td>{{$detail->prihal}}</td>
                                            <td>{{$detail->digunakan}}</td>
                                            <td><img src="{{$message->embed(asset('img/bukti/'.$detail->foto))}}" alt="bukti" ></td>
