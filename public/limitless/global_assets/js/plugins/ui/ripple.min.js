...
! function (t) {
    t.fn.ripple = function (e) {
        ...
        var d, f, h, m, g = {},
            ...
            w = function (e) {
                h = [d.outerWidth(), d.outerHeight()], x(), m = e, f = t("<div/>").addClass("legitRipple-ripple"), g.template && f.append(("object" == typeof g.template ? g.template : d.children(".legitRipple-template").last()).clone().removeClass("legitRipple-template")).addClass("legitRipple-custom"), f.appendTo(d), D(e, !1);
